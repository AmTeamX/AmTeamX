...
| :--- | :--- | :--- |
| **[BONDUP](https://play.google.com/store/apps/details?id=com.bondupmvs.com)** | Real-time community activity management app. | Flutter, Firebase, Clean Architecture |
| **[BlinkDx](https://github.com/AmTeamX)** | AI system for blink anomaly detection (95% accuracy). | Python, PyTorch, Computer Vision |
| **[MUICT Open House](https://github.com/AmTeamX)** | High-concurrency registration system for 200+ users. | Next.js, Express, MongoDB |
